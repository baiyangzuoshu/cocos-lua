...
function container.CreateCustomNode()
    ...
    CustomButton:loadTextureNormal("Default/Button_Normal.png", 1)
    CustomButton:loadTexturePressed("Default/Button_Press.png", 1)
    CustomButton:loadTextureDisabled("Default/Button_Disable.png", 1)
    ...
    CustomButton:addTouchEventListener(function(ref, type)
        if type == 0 then
            ...
            if string.len(ref.clickEffect) > 0 then
                SoundSystemManager:playEffect("music/02sound/" .. ref.clickEffect .. ".mp3")
            end
