...
int lua_cocos2dx_extension_Manifest_setManifestFileUrl(lua_State* tolua_S) {
    int argc = 0;
    cocos2d::extension::Manifest* cobj = nullptr;
    bool ok = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_Manifest_setManifestFileUrl'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1)
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "cc.Manifest:setManifestFileUrl"); arg0 = arg0_tmp.c_str();
        if (!ok)
        {
            tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_Manifest_setManifestFileUrl'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.Manifest:setManifestFileUrl", argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_Manifest_setManifestFileUrl'.", &tolua_err);
#endif
...
int lua_cocos2dx_extension_Manifest_setPackageUrl(lua_State* tolua_S) {
    int argc = 0;
    cocos2d::extension::Manifest* cobj = nullptr;
    bool ok = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_Manifest_setPackageUrl'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1)
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "cc.Manifest:setPackageUrl"); arg0 = arg0_tmp.c_str();
        if (!ok)
        {
            tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_Manifest_setPackageUrl'", nullptr);
            return 0;
        }
        cobj->setPackageUrl(arg0);
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.Manifest:setPackageUrl", argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_Manifest_setPackageUrl'.", &tolua_err);
#endif
...
int lua_cocos2dx_extension_Manifest_setVersionFileUrl(lua_State* tolua_S) {
    int argc = 0;
    cocos2d::extension::Manifest* cobj = nullptr;
    bool ok = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_Manifest_setVersionFileUrl'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1)
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "cc.Manifest:setVersionFileUrl"); arg0 = arg0_tmp.c_str();
        if (!ok)
        {
            tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_Manifest_setVersionFileUrl'", nullptr);
            return 0;
        }
        cobj->setVersionFileUrl(arg0);
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.Manifest:setVersionFileUrl", argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_Manifest_setVersionFileUrl'.", &tolua_err);
#endif
...
int lua_register_cocos2dx_extension_Manifest(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Manifest");
        ...
        tolua_function(tolua_S, "setManifestFileUrl", lua_cocos2dx_extension_Manifest_setManifestFileUrl);
        ...
        tolua_function(tolua_S, "setPackageUrl", lua_cocos2dx_extension_Manifest_setPackageUrl);
        ...
        tolua_function(tolua_S, "setVersionFileUrl", lua_cocos2dx_extension_Manifest_setVersionFileUrl);
