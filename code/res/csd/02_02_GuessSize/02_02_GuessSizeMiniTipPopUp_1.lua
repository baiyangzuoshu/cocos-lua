...
ContentText_1_TT:setString([[当前本金金额不足]])
...
--Create ContentText_1_1_TT
local ContentText_1_1_TT = ccui.Text:create()
ContentText_1_1_TT:ignoreContentAdaptWithSize(false)
ContentText_1_1_TT:setFontName("font/Default.ttf")
ContentText_1_1_TT:setFontSize(32)
ContentText_1_1_TT:setString([[本轮游戏结束]])
ContentText_1_1_TT:setTextHorizontalAlignment(1)
ContentText_1_1_TT:setTextVerticalAlignment(2)
ContentText_1_1_TT:setLayoutComponentEnabled(true)
ContentText_1_1_TT:setName("ContentText_1_1_TT")
ContentText_1_1_TT:setTag(11)
ContentText_1_1_TT:setCascadeColorEnabled(true)
ContentText_1_1_TT:setCascadeOpacityEnabled(true)
ContentText_1_1_TT:setVisible(false)
ContentText_1_1_TT:setPosition(359.0000, 295.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(ContentText_1_1_TT)
layout:setSize({width = 600.0000, height = 84.0000})
layout:setLeftMargin(59.0000)
layout:setRightMargin(-659.0000)
layout:setTopMargin(-337.0000)
layout:setBottomMargin(253.0000)
Middle:addChild(ContentText_1_1_TT)

--Create ContentText_1_2_TT
local ContentText_1_2_TT = ccui.Text:create()
ContentText_1_2_TT:ignoreContentAdaptWithSize(false)
ContentText_1_2_TT:setFontName("font/Default.ttf")
ContentText_1_2_TT:setFontSize(32)
ContentText_1_2_TT:setString([[当前庄家被抢]])
ContentText_1_2_TT:setTextHorizontalAlignment(1)
ContentText_1_2_TT:setTextVerticalAlignment(2)
ContentText_1_2_TT:setLayoutComponentEnabled(true)
ContentText_1_2_TT:setName("ContentText_1_2_TT")
ContentText_1_2_TT:setTag(10)
ContentText_1_2_TT:setCascadeColorEnabled(true)
ContentText_1_2_TT:setCascadeOpacityEnabled(true)
ContentText_1_2_TT:setVisible(false)
ContentText_1_2_TT:setPosition(359.0000, 295.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(ContentText_1_2_TT)
layout:setSize({width = 600.0000, height = 84.0000})
layout:setLeftMargin(59.0000)
layout:setRightMargin(-659.0000)
layout:setTopMargin(-337.0000)
layout:setBottomMargin(253.0000)
Middle:addChild(ContentText_1_2_TT)

--Create ContentText_2_TT
local ContentText_2_TT = ccui.Text:create()
ContentText_2_TT:ignoreContentAdaptWithSize(false)
ContentText_2_TT:setFontName("font/Default.ttf")
ContentText_2_TT:setFontSize(32)
ContentText_2_TT:setString([[Additional cost: 5555W snatch rate]])
ContentText_2_TT:setTextHorizontalAlignment(1)
ContentText_2_TT:setLayoutComponentEnabled(true)
ContentText_2_TT:setName("ContentText_2_TT")
ContentText_2_TT:setTag(1178)
ContentText_2_TT:setCascadeColorEnabled(true)
ContentText_2_TT:setCascadeOpacityEnabled(true)
ContentText_2_TT:setPosition(359.0000, 194.0000)
