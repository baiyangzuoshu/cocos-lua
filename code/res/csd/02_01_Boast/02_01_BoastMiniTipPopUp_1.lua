...
ContentText_TT:setString([[您的金币不足，无法进入此房间]])
...
ContentText_TT:setPosition(359.0000, 260.0000)
...
ContentText_1_TT:setString([[您的金币不足，无法创建此房间]])
...
ContentText_1_TT:setTag(96)
ContentText_1_TT:setCascadeColorEnabled(true)
ContentText_1_TT:setCascadeOpacityEnabled(true)
ContentText_1_TT:setVisible(false)
ContentText_1_TT:setPosition(359.0000, 260.0000)
