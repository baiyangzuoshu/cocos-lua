...
ContentText_TT:setString([[是否邀请全服玩家一起吹牛？]])
...
--Create GoldNumNode
local GoldNumNode=cc.Node:create()
GoldNumNode:setName("GoldNumNode")
GoldNumNode:setTag(1572)
GoldNumNode:setCascadeColorEnabled(true)
GoldNumNode:setCascadeOpacityEnabled(true)
layout = ccui.LayoutComponent:bindLayoutComponent(GoldNumNode)
Middle:addChild(GoldNumNode)

--Create GoldNumIcon
local GoldNumIcon = ccui.ImageView:create()
GoldNumIcon:ignoreContentAdaptWithSize(false)
GoldNumIcon:loadTexture("00_02_Default/2.png", 1)
GoldNumIcon:setScale9Enabled(true)
GoldNumIcon:setCapInsets({x = 15, y = 13, width = 10, height = 14})
GoldNumIcon:setLayoutComponentEnabled(true)
GoldNumIcon:setName("GoldNumIcon")
GoldNumIcon:setTag(1573)
GoldNumIcon:setCascadeColorEnabled(true)
GoldNumIcon:setCascadeOpacityEnabled(true)
GoldNumIcon:setPosition(174.0000, 190.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(GoldNumIcon)
...
GoldNumNode:addChild(GoldNumIcon)
...
GoldNum:setFontSize(24)
GoldNum:setString([[10万]])
GoldNum:setTextHorizontalAlignment(1)
...
GoldNum:setAnchorPoint(1.0000, 0.5000)
GoldNum:setPosition(244.5725, 189.5270)
GoldNum:setTextColor({r = 193, g = 189, b = 237})
layout = ccui.LayoutComponent:bindLayoutComponent(GoldNum)
layout:setSize({width = 51.0000, height = 28.0000})
layout:setLeftMargin(193.5725)
layout:setRightMargin(-244.5725)
layout:setTopMargin(-203.5270)
layout:setBottomMargin(175.5270)
GoldNumNode:addChild(GoldNum)

--Create GoldNumText_TT
local GoldNumText_TT = ccui.Text:create()
GoldNumText_TT:ignoreContentAdaptWithSize(true)
GoldNumText_TT:setTextAreaSize({width = 0, height = 0})
GoldNumText_TT:setFontName("font/Default.ttf")
GoldNumText_TT:setFontSize(24)
GoldNumText_TT:setString([[/次]])
GoldNumText_TT:setTextVerticalAlignment(1)
GoldNumText_TT:setLayoutComponentEnabled(true)
GoldNumText_TT:setName("GoldNumText_TT")
GoldNumText_TT:setTag(1575)
GoldNumText_TT:setCascadeColorEnabled(true)
GoldNumText_TT:setCascadeOpacityEnabled(true)
GoldNumText_TT:setAnchorPoint(0.0000, 0.5000)
GoldNumText_TT:setPosition(244.5731, 190.5298)
GoldNumText_TT:setTextColor({r = 193, g = 189, b = 237})
layout = ccui.LayoutComponent:bindLayoutComponent(GoldNumText_TT)
layout:setSize({width = 37.0000, height = 32.0000})
layout:setLeftMargin(244.5731)
layout:setRightMargin(-281.5731)
layout:setTopMargin(-206.5298)
layout:setBottomMargin(174.5298)
GoldNumNode:addChild(GoldNumText_TT)
