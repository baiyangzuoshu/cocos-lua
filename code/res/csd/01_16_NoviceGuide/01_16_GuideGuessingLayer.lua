...
--Create StakeText_1
local StakeText_1 = ccui.Text:create()
StakeText_1:ignoreContentAdaptWithSize(true)
StakeText_1:setTextAreaSize({width = 0, height = 0})
StakeText_1:setFontName("font/Default.ttf")
StakeText_1:setFontSize(26)
StakeText_1:setString([[选择一方，押注234.5萬金币]])
StakeText_1:setTextVerticalAlignment(1)
StakeText_1:setLayoutComponentEnabled(true)
StakeText_1:setName("StakeText_1")
StakeText_1:setTag(297)
StakeText_1:setCascadeColorEnabled(true)
StakeText_1:setCascadeOpacityEnabled(true)
StakeText_1:setPosition(360.0000, 482.0004)
layout = ccui.LayoutComponent:bindLayoutComponent(StakeText_1)
...
TimeText:setString([[5 秒后结束竞猜]])
TimeText:setTextHorizontalAlignment(1)
TimeText:setTextVerticalAlignment(1)
...
TimeText:setPosition(358.0032, 437.0031)
TimeText:setTextColor({r = 160, g = 160, b = 160})
