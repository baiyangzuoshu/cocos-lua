...
--Create TipContentText_1_TT
local TipContentText_1_TT = ccui.Text:create()
TipContentText_1_TT:ignoreContentAdaptWithSize(false)
TipContentText_1_TT:setFontName("font/Default.ttf")
TipContentText_1_TT:setFontSize(32)
TipContentText_1_TT:setString([[確定要解除XX11111111111111X綁定？]])
TipContentText_1_TT:setTextHorizontalAlignment(1)
TipContentText_1_TT:setTextVerticalAlignment(1)
TipContentText_1_TT:setLayoutComponentEnabled(true)
TipContentText_1_TT:setName("TipContentText_1_TT")
TipContentText_1_TT:setTag(254)
TipContentText_1_TT:setCascadeColorEnabled(true)
TipContentText_1_TT:setCascadeOpacityEnabled(true)
TipContentText_1_TT:setPosition(360.0000, 280.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(TipContentText_1_TT)
...
Middle:addChild(TipContentText_1_TT)

--Create TipContentText_2_TT
local TipContentText_2_TT = ccui.Text:create()
TipContentText_2_TT:ignoreContentAdaptWithSize(false)
TipContentText_2_TT:setFontName("font/Default.ttf")
TipContentText_2_TT:setFontSize(24)
TipContentText_2_TT:setString([[解除XXX账号后将无法使用它继续登录游戏]])
TipContentText_2_TT:setTextHorizontalAlignment(1)
TipContentText_2_TT:setTextVerticalAlignment(1)
TipContentText_2_TT:setLayoutComponentEnabled(true)
TipContentText_2_TT:setName("TipContentText_2_TT")
TipContentText_2_TT:setTag(264)
TipContentText_2_TT:setCascadeColorEnabled(true)
TipContentText_2_TT:setCascadeOpacityEnabled(true)
TipContentText_2_TT:setPosition(369.9995, 190.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(TipContentText_2_TT)
layout:setSize({width = 600.0000, height = 64.0000})
layout:setLeftMargin(69.9995)
layout:setRightMargin(-669.9995)
layout:setTopMargin(-222.0000)
layout:setBottomMargin(158.0000)
Middle:addChild(TipContentText_2_TT)
...
CancelButton:setPosition(505.9995, 100.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(CancelButton)
layout:setSize({width = 208.0000, height = 98.0000})
layout:setLeftMargin(401.9995)
layout:setRightMargin(-609.9995)
layout:setTopMargin(-149.0000)
layout:setBottomMargin(51.0000)
