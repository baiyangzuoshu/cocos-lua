...
local M = class("UIEmailItem2", UIPanel)
...
function M:showDiamond()
    ...
    local isReceived = self.mItemInfo:getIsReceived()
    if isReceived then 
        self.itemIcon:setOpacity(255 * 0.5)
        self.itemNum:setOpacity(255 * 0.5)
        self.PropFrame:setOpacity(255 * 0.2)
    else
        self.itemIcon:setOpacity(255)
        self.itemNum:setOpacity(255)
        self.PropFrame:setOpacity(255)
    end
end
